...
try:
    ...
    from backend.routers import health, speech, chat, query, history, auth, documents, dashboard
except ImportError:
    ...
    from routers import health, speech, chat, query, history, auth, documents, dashboard
